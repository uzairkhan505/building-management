                ...
                <div class="col-xl-9 mx-auto ">
                    ...
                    <div class="card border-top  border-white">
                        <div class="card-body p-5">
                            ...
                            @endif
                            <form class="row g-3" action="{{ route('activity_logs.store') }}" method="POST">
                                @csrf
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="activity_type" name="activity_type">
                                        ...
                                        <option value="hire" {{ old('activity_type')=='hire' ? 'selected' : '' }}>Hire</option>
                                        <option value="fire" {{ old('activity_type')=='fire' ? 'selected' : '' }}>Fire</option>
                                        <option value="update" {{ old('activity_type')=='update' ? 'selected' : '' }}>Update</option>
                                    </select>
                                    @error('activity_type')
