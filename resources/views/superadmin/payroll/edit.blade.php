                    ...
                    <div class="card border-top  border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Payroll Edit</h5>
                            </div>
                            <hr>
                        ...
                        <!-- Display Success Message -->
                            ...
                            <form class="row g-3" action="{{ route('payroll.update',$payroll->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="employee_id" name="employee_id">
                                       ...
                                       @foreach($employees as $row)
                                            <option value="{{$row->id}}" {{$row->id == $payroll->employee_id ? 'selected' : ''}}>{{$row->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('employee_id')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="salary_amount" name="salary_amount"
                                           ...
                                           value="{{ old('salary_amount',$payroll->salary_amount) }}">
                                    @error('salary_amount')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="deducation" name="deducation"
                                           placeholder="Salary"
                                           value="{{ old('deducation',$payroll->deducation) }}">
                                    @error('deducation')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" id="pay_date"
                                           name="pay_date"
                                           placeholder="Rate per/sq feet" value="{{ old('pay_date',$payroll->pay_date) }}">
                                    @error('pay_date')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
