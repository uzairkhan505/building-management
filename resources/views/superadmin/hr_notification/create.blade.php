                    ...
                    <div class="card border-top  border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Hr Notification Add</h5>
                            </div>
                            <hr>
                            ...
                            <form class="row g-3" action="{{ route('hr_notification.store') }}" method="POST">
                                @csrf
                                <div class="col-md-6">
                                    <label for="notification_type" class="form-label">Notification Type</label>
                                    <select class="form-control" id="notification_type" name="notification_type">
                                        <option value="" selected>Nothing Selected</option>
                                        <option value="salary_alert" {{ old('notification_type')=='salary_alert' ? 'selected' : '' }}>
                                            Salary Alert
                                        </option>
                                        <option value="hr_notification" {{ old('notification_type')=='hr_notification' ? 'selected' : '' }}>
                                            Hr Notification
                                        </option>
                                    </select>
